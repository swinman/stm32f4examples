...
void EXTI0_IRQHandler(void)
{
  ...
  {
    /* Call KEY Button Handler */
    Wakeup_Button_Handler();
    /* Clears the WAKEUP Button EXTI line pending bit */
    EXTI_ClearITPendingBit(WAKEUP_BUTTON_EXTI_LINE);
  }
}

/**
  * @brief  This function handles External IT 10..15 interrupt request.
  * @param  None
  * @retval None
  */
void EXTI15_10_IRQHandler(void)
{
  if (EXTI_GetITStatus(KEY_BUTTON_EXTI_LINE) != RESET)
  {
    /* Call KEY Button Handler */
    Key_Button_Handler();
    /* Clears the KEY Button EXTI line pending bit */
