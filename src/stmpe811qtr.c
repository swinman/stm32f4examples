...
TS_STATE TS_State;
    /* The global structure holding the TS state */
...
uint8_t IOE_GITConfig(uint8_t DeviceAddr,
        uint8_t Global_IT, FunctionalState NewState) {
  uint8_t tmp = 0;
...
uint8_t IOE_IOITConfig(uint8_t DeviceAddr,
        uint8_t IO_IT, FunctionalState NewState) {
  uint8_t tmp = 0;
...
uint8_t IOE_IOAFConfig(uint8_t DeviceAddr,
        uint8_t IO_Pin, FunctionalState NewState) {
  uint8_t tmp = 0;
...
uint8_t I2C_WriteDeviceRegister(uint8_t DeviceAddr,
            uint8_t RegisterAddr, uint8_t RegisterValue) {
